...
// This file was generated at 2018-02-05 15:10:28.766475 +0100 CET m=+0.276318359
...
func (o *Operations) UnmarshalJSON(data []byte) error {
	...
	for _, v := range ops {
		...
		// add the operation already to the list of operations, regardless if we can unmarshal the options or not
		*o = append(*o, op.(Operation))
		...
		if err := json.Unmarshal(v.Options, op); err != nil {
			...
			//               has options on an operation which are not of the correct type. In the optimal case this shouldn't happen
			//               and an effort is being made to correct this. In the mean time, continue can be left here.
			continue
		}
	}
	return nil
